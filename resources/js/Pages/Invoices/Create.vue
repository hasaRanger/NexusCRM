...
<template>
    <AppLayout title="New Invoice | NexusCRM">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-foreground leading-tight">New Invoice</h2>
        </template>
                    ...
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="0.00"
                            />
                            <p v-if="form.errors.tax" class="mt-1 text-sm text-red-600">{{ form.errors.tax }}</p>
                        </div>
