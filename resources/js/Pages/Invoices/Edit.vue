...
<template>
    <AppLayout title="Edit Invoice | NexusCRM">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-foreground leading-tight">Edit Invoice</h2>
        </template>
                ...
                <div class="bg-white dark:bg-card shadow-sm sm:rounded-lg p-6">
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="w-full px-3 py-2 bg-gray-100 dark:bg-secondary border border-gray-350 dark:border-border rounded-md text-gray-700 dark:text-gray-300 select-none">
