...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900 dark:text-foreground">Profile Information</h2>
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                >
                    <p v-if="form.recentlySuccessful" class="text-sm text-gray-600 dark:text-muted-foreground">Saved.</p>
                </Transition>
            </div>
        </form>
    </section>
